...
.state('STOPPED')
 ...
 .name(this.DCMotor)
  ...
  .when('STOPPED', { allow: ['RotateForwardinRPM'] })  
  .when('RotatingForward', { allow: ['SpeedUpinRPM','Stop'] })
  .when('SpeedingUp', { allow: ['SpeedDowninRPM','Stop','SpeedUpinRPM'] })
   .when('SpeedingDown', { allow: ['SpeedUpinRPM','Stop','SpeedDowninRPM'] })
